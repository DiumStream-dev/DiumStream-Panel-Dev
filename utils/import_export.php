...
<body class="bg-gray-900 text-white">
    <div class="container mx-auto mt-8 px-4">
        <h1 class="text-4xl font-bold mb-8 text-center">Importer/Exporter</h1>
        ...
        <div class="bg-gray-800 rounded-lg shadow-xl p-8 max-w-4xl mx-auto">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="mb-6">
                            ...
                            <div class="flex items-center">
                                ...
                                <span id="file-name" class="bg-gray-600 text-gray-300 py-3 px-4 rounded-r w-1/2 truncate">Aucun fichier choisi</span>
                            </div>
                        </div>
                ...
                <div class="bg-gray-700 p-6 rounded-lg shadow-md">
                    ...
                    <form method="get" action="" id="exportForm">
                        ...
                        <div class="space-y-3 mb-6 max-h-96 overflow-y-auto pr-2 custom-scrollbar">
                            <h3 class="text-lg font-semibold mb-2">Tables à exporter</h3>
                            <?php
                            $tables = [
                                'logs',
                                'ignored_folders',
                            ...
                            foreach ($tables as $table) {
                                echo "<label class='flex items-center text-gray-300 hover:bg-gray-600 p-2 rounded transition duration-200 ease-in-out'>
        ...
        <div id="accessDeniedOverlay" class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
            <div class="bg-gray-800 p-8 rounded-lg text-center">
                ...
                <p class="mb-6">Vous n'avez pas la permission d'accéder à Importer/Exporter.</p>
    ...
    <div id="errorOverlay" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
        <div class="bg-gray-800 p-8 rounded-lg text-center">
            <h3 class="text-xl font-bold mb-4">Erreur</h3>
            <p class="mb-6">Veuillez sélectionner au moins une table à exporter.</p>
